  ...
  <section>
    ...
    <div class="card p-20 mt-15">
      <ul class="list-unstyle row">
        ...
        <li class="col-xs-8 col-sm-5 color-gray-light">{{data.server.storageType}}&nbsp;</li>
        <li class="col-xs-4 col-sm-2">서버 이름</li>
        <li class="col-xs-8 col-sm-3 color-gray-light">{{data.server.serverName}}&nbsp;</li>
        <li class="col-xs-4 col-sm-2 pt-10">서버 타입</li>
        <li class="col-xs-8 col-sm-5 pt-10 color-gray-light">{{data.server.typeName}}&nbsp;</li>
        <li class="col-xs-4 col-sm-2 pt-10">요금제</li>
        <li class="col-xs-8 col-sm-3 pt-10 color-gray-light">{{data.server.FeeSystemType === 'FXSUM' ? '월요금제' : '시간 요금제'}}</li>
      </ul>
      <ul class="list-unstyle row">
        <li class="col-xs-4 col-sm-2 pt-10">Zone</li>
        <li class="col-xs-8 col-sm-5 pt-10 color-gray-light">{{data.server.zone}}&nbsp;</li>
        <li class="col-xs-4 col-sm-2 pt-10">반납 보호</li>
        <li class="col-xs-8 col-sm-3 pt-10 color-gray-light">{{data.server.returnProtection === 'TRUE' ? '설정' : '해제'}}</li>
      </ul>
    </div>
